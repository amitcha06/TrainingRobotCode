...
final class OrbitFalcon extends WPI_TalonFX implements OrbitMotor {

    private final float motorPerPhysicalUnitsRatio;
    private final int id;

    public OrbitFalcon(final MotorProps props) {
        super(props.port);
    ...
    public void enableCurrentLimit() {
        throw new UnsupportedOperationException("##1690 Error## no such function as enableCurrentLimit for falcon");
    }
    ...
    public void setPeriod(final int dt_MilliSec) {
        ...
        setStatusFramePeriod(StatusFrameEnhanced.Status_2_Feedback0, 10);
        setStatusFramePeriod(StatusFrameEnhanced.Status_3_Quadrature, 1100 + dt_MilliSec);
        setStatusFramePeriod(StatusFrameEnhanced.Status_4_AinTempVbat, 1200);
        ...
        setStatusFramePeriod(StatusFrameEnhanced.Status_13_Base_PIDF0, 200);
    ...
    public void setSlave(final int masterPort) {
        set(TalonFXControlMode.Follower, masterPort);
    }
